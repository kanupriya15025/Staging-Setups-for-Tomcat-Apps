...
apps = requests.get("<dcos-endpoint>/v2/apps/<app-group>/*")
	...
	for app in apps_list:
		...
		if (len(app['tasks'])>0):
			...
			if(ts-max_ts>18000):  #5hrs
				print max_ts
				print("<dcos-endpoint>/v2/apps"+app['id'])
				print app['id']
				payload={'id':app['id'],'instances':0}
				scale_down_request = requests.put("<dcos-endpoint>/v2/apps"+app['id'],json=payload)
